...
class Reservation:
    ...
    def create_reservation(self, customer_name, hotel_name, room_number):
        ...
        for reservation in self.reservations:
            if reservation['hotel_name'] == hotel_name and reservation['room_number'] == room_number:
                print(f"The room '{room_number}' in '{hotel_name}' is already reserved.")
                return
        reservation = {
    ...
    def cancel_reservation(self, customer_name, hotel_name):
        ...
        """
        for reservation in self.reservations:
            if reservation['customer_name'] == customer_name and reservation['hotel_name'] == hotel_name:
